...
srcs/sort_functions.c srcs/sort.c srcs/start_the_programm.c srcs/print_err_arg.c srcs/if_direrror.c
INCS = libft/
...
sort_functions.o sort.o start_the_programm.o print_err_arg.o if_direrror.o
NAME = ft_ls
